...
var got = require('got');//see issue https://github.com/matheuss/google-translate-token/issues/3
var Configstore = require('configstore'); //this package causing problems, changed package to 2.0 without success, currently on 3.1.1
